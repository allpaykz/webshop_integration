 ...
 * 
 * Общение с сервером Allpay происходит с использованием формата XML
 * Каждое сообщение подписыватся по стандарту XMLDSig
 *
 * В этом классе реализованы методы для общения с сервером и корректной работы с подписями
 *
